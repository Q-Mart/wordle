...
this.wordle.bundle = function (e) {
  ...
  Fa = [
  ].concat(g(Ba.split('').slice(13)), g(Ba.split('').slice(0, 13)));
  function Wa(e) {
    ...
    return o(t, [
      {
        ...
        value: function () {
          if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
            ...
            if (e = s, !Ta.includes(e) && !La.includes(e)) return a.setAttribute('invalid', ''),
            ...
            if (this.hardMode) {
              var t = function (e, a, s) {
                ...
                Ia].includes(s[n]) && (o[a[n]] ? o[a[n]] += 1 : o[a[n]] = 1);
      ...
      },
      {
        ...
        value: function () {
          ...
          this.$game.addEventListener('game-last-tile-revealed-in-row', (function (a) {
            ...
            (a.path || a.composedPath && a.composedPath()).includes(s) && ([es,
            as].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === es && (s.setAttribute('win', ''), e.addToast(ss[e.rowIndex - 1], 2000)), e.gameStatus === as && e.addToast(e.solution.toUpperCase(), 1 / 0), setTimeout((function () {
              e.showStatsModal()
    ...
    return cs(this, void 0, void 0, (function () {
      ...
      return ps(this, (function (s) {
        if (a = 'text/plain' in e, 'undefined' == typeof ClipboardEvent && void 0 !== ws.clipboardData && void 0 !== ws.clipboardData.setData) {
          ...
          if (t = e['text/plain'], ws.clipboardData.setData('Text', t)) return [2,
          !0];
      ...
      },
      {
        ...
        value: function () {
          ...
          if (s <= 0) e = '00:00:00';
            ...
            var t = Math.floor(s % 86400000 / Js),
